...
public:
    ...
    void setupUi(QWidget *ChatPage)
    {
        ...
        horizontalSpacer_7 = new QSpacerItem(5, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_6 = new QSpacerItem(5, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
        ...
        chatEdit->setFrameShape(QFrame::Shape::NoFrame);
